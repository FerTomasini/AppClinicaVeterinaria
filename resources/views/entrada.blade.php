...
@section('corpo')
  ...
  <div class="card">
    <img class="card-img-top" src="{{ asset('imagens/cachorrinhos.jpg')}}" alt="ninhada">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img-top" src="{{ asset('imagens/dogcoçando.jpg') }}" alt="cachorrocoçando">
    <div class="card-body">
  ...
  <div class="card">
    <img class="card-img" src="{{ asset('imagens/consulta.jpg') }}" alt="consulta">
  </div>
